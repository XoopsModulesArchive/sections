...
// $Id: index.php,v 1.2 2006/06/14 20:07:04 mikhail Exp $
// ------------------------------------------------------------------------ //
...
<table border='0' width='100%' align='center' cellpadding='1'><tr><td align='center'>";
        ...
        while (list($secid, $secname) = $xoopsDB->fetchRow($result)) {
            $secname = htmlspecialchars($secname, ENT_QUOTES | ENT_HTML5);
...
function secartedit($artid)
{
    ...
    [$artid, $secid, $title, $content] = $xoopsDB->fetchRow($result);
    ...
    <?php echo '<form action="index.php" method="post">'; ?><br>
    <b><?php echo _MD_TITLEC; ?></b><br>
    <input class="textbox" type="text" name="title" size="60" value="<?php echo (string)$title; ?>"><br><br>
    <?php
    ...
    <br>
    <b><?php echo _MD_CONTENTC; ?></b><br>
    <textarea class="textbox" name="content" cols="60" rows="10"><?php echo (string)$content; ?></textarea>
    <input type="hidden" name="artid" value="<?php echo (string)$artid; ?>">
...
function sectionedit($secid)
{
    ...
    <?php echo '<form action="index.php" method="post">'; ?><br>
    <b><?php echo _MD_SECNAMEC; ?></b> <?php echo _MD_MAXCHAR; ?><br>
    <input class="textbox" type="text" name="secname" size="40" maxlength="40" value="<?php echo (string)$secname; ?>"><br><br>
    <b><?php echo _MD_SECIMAGEC; ?></b> <?php echo _MD_EXIMAGE; ?><br>
    <input class="textbox" type="text" name="image" size="40" maxlength="50" value="<?php echo (string)$image; ?>"><br><br>
    <input type="hidden" name="secid" value="<?php echo (string)$secid; ?>">
...
switch ($op) {
    ...
    case 'secartdelete':
        ...
        $title = htmlspecialchars($title, ENT_QUOTES | ENT_HTML5);
        xoops_confirm(['op' => 'secartdelete_ok', 'artid' => $artid], 'index.php', sprintf(_MD_DELETETHISART, $title) . '<br><br>' . _MD_RUSUREDELART);
        break;
    ...
    case 'sectiondelete':
        xoops_cp_header();
        echo '<h4>' . _AM_SECCONF . '</h4>';
        xoops_confirm(['op' => 'sectiondelete_ok', 'secid' => $secid], 'index.php', _MD_RUSUREDELSEC . '<br>' . _MD_THISDELETESALL);
        break;
